...
class ClientRow extends React.Component {
    ...
    render() {
        const{name,vatNumber,invoiceCount,countOfoverdueInvoices}
        return (
            <React.Fragment>
                <TableRow className={classes.root}>
                    ...
                    <TableCell align="right">{invoiceCount}</TableCell>
                                    ...
                                    <TableBody>
                                        {invoices.map((invoice) => (
                                            <TableRow key={invoice.id}>
                                                ...
                                                <TableCell align="right">{invoice.maturytyDate}</TableCell>
