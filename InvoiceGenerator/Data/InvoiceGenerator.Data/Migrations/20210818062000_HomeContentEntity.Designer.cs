...
namespace InvoiceGenerator.Data.Migrations
{
    ...
    [Migration("20210818062000_HomeContentEntity")]
    partial class HomeContentEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceGenerator.Data.Models.HomeContent", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InvoiceGenerator.Data.Models.HomeContentToUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("HomeContentId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InvoiceGenerator.Data.Models.HomeContentToUser", b =>
                {
                    b.HasOne("InvoiceGenerator.Data.Models.HomeContent", "HomeContent")
                        .WithMany("Users")
                        .HasForeignKey("HomeContentId");

                    b.HasOne("InvoiceGenerator.Data.Models.ApplicationUser", "User")
                        .WithMany("HomePageContent")
