...
const baseUrl = document.getElementsByTagName('base')[0].baseURI+'api';
const azureBlobBaseUrl = 'https://pdfinvoicegenerator.blob.core.windows.net'
...
export default {
    ...
    getBankAccounts: `${baseUrl}/BankAccounts`,
    createBankAccount: `${baseUrl}/BankAccounts`,
